...
<head>
    ...
    <title>Forgot Password — BiteSpeed</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        ...
        <p>Enter your registered operator email on the login page or request an OTP reset token to verify identity.</p>
        <a href="<%=request.getContextPath()%>/login.jsp" class="btn-home">Back to Login</a>
    </div>
</body>
</html>