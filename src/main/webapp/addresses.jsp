...
<head>
    ...
    <title>Manage Addresses — BiteSpeed</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        ...
        <p>Save and manage your primary delivery coordinates for rapid 30-minute drone dispatching.</p>
        <a href="<%=request.getContextPath()%>/profile.jsp" class="btn-home">Return to Profile</a>
    </div>
</body>
</html>