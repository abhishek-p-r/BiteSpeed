...
<head>
    ...
    <title>About BiteSpeed — Luxury Gastronomy</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        <h2>About BiteSpeed</h2>
        <p>BiteSpeed is a sub-orbital quantum gastronomy logistics courier. Delivering luxury culinary experiences from handpicked master chefs in under 30 minutes.</p>
