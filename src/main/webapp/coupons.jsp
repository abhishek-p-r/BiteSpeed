...
<head>
    ...
    <title>Browse Promo Coupons — BiteSpeed</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        <h2>Promo Coupons</h2>
        <p>Use coupon code <strong>BITE100</strong> to get flat ₹100 OFF on your first order. Additional offers automatically apply at checkout.</p>
