...
<head>
    ...
    <title>404 — Page Not Found — BiteSpeed</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        <h2>404 — Logistics Route Not Found</h2>
        <p>The requested sub-orbital coordinate does not exist or has been relocated to another sector.</p>
