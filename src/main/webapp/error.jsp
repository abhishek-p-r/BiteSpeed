...
<head>
    ...
    <title>System Exception — BiteSpeed</title>
...
<body>
    ...
    <div class="info-card" style="margin-top: 120px;">
        <h2>System Error Dispatch</h2>
        <p>An unexpected internal telemetry exception occurred. Our technical team has been notified.</p>
